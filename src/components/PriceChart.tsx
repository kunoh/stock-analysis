                ...
                if (active && payload && payload.length) {
                  ...
                  return (
                    <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-3">
                      ...
                      <p className="text-lg font-semibold">{sym}{data.close.toFixed(2)}</p>
                      <div className="text-xs text-gray-500 mt-1">
                        <p>Open: {sym}{data.open.toFixed(2)}</p>
                        <p>High: {sym}{data.high.toFixed(2)}</p>
                        <p>Low: {sym}{data.low.toFixed(2)}</p>
                      </div>
                    </div>
                  );
                }
